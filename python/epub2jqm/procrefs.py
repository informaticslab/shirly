...
def write_references_page_body_start(f, headingId):
    ...
    f.write('''" data-theme="d">
            <div data-role="header" data-id="references-header" data-theme="j" data-position="fixed">
                <a href="''')
...
def write_heading_content(headingId):
    ...
    with open("page/refs/headings/" + str(headingId) + ".html", "w") as hidf:
        ...
        try:
            ...
            with open("temp/refs/heading-content-raw/" + str(headingId) + ".html", "r") as thcf:
                try:
                    ## Read the first line
                    line = thcf.readline()
                    while line:
...
def write_temp_heading_content(headingId, headingTag):
    # write current heading, and content between current and next heading
    # to heading content file as HTML using heading ID as name
    with open("temp/refs/heading-content-raw/" + str(headingId) + ".html", "w") as thcf:
...
def write_children_listview(headingId):
    # write current heading, and content between current and next heading
    # to heading content file as HTML using heading ID as name
    with open("page/refs/headings/lv-" + str(headingId) + ".html", "w") as lvf:
